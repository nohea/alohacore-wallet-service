...
Iquidus.prototype.getUtxos = function(addresses, cb) {
    ...
    // need to loop since /ext/listunspent only supports one address, unlike /addrs/utxo
//    var utxos = [];
//    _.forEach(addresses, function(addr, cb) {
//	var addrUtxos = .getUtxosSingleAddr(addr, cb);
//	if(addrUtxos) {
